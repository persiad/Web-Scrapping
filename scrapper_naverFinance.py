...
def max_page(url: str) -> int:
    ...
    # make sure to install lxml package; otherwise the next line will not run
...
def get_data(url: str, last: int):
    ...
    for page in range(1, int(last) + 1):
        ...
        # you can use either of the following lines: append or concatenate
